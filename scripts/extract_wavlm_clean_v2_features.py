...
ROOT=Path('.'); OUT=ROOT/'models/speech/wavlm_clean_v2_layer_stats.npy'; META=ROOT/'models/speech/wavlm_clean_v2_layer_stats_metadata.json'
...
if OUT.exists() and META.exists() and json.loads(META.read_text(encoding='utf8')).get('fingerprint')==fingerprint:
 print('澶嶇敤',OUT); raise SystemExit
